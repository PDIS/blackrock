...
#ifndef BLACKROCK_EMPTY_H_
#define BLACKROCK_EMPTY_H_
...
class EmptyDriver: public ComputeDriver {
public:
  EmptyDriver(sandstorm::SubprocessSet& subprocessSet, kj::LowLevelAsyncIoProvider& ioProvider);
  ~EmptyDriver() noexcept(false);
